...
namespace Tagging
{
    ...
    public abstract class CacheManager<T> : IEnumerable<T>
    {
        /// <summary>
        /// 一次取得所有資料項目
        /// </summary>
        ...
        public void SyncAll()
        {
            ...
            try
            {
                ...
                if (_CanSort)
                {
                    ...
                    {
                        if (_List.ContainsKey(items[item]))
        ...
        /// </summary>
        public virtual void SyncAllBackground()
        {
            _Loaded = false;
            //重新取得所有資料
    ...
    public class ItemUpdatedEventArgs : EventArgs
    {
        ...
        public ItemUpdatedEventArgs(IEnumerable<string> primaryKeys)
        {
